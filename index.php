...
<main>
    ...
    <div class='pizza'>
        ...
        <div class="update">
            <a class='up' href=<?php echo "update.php?nom={$pizza['nom']}&prix_vente={$pizza['prix_vente']}&note_consommateur={$pizza['note_consommateur']}" ?> >UP</a>
        ...
        <div>
            <a class="oui" href=<?php echo "traitement.php?action=del&pizza={$pizza['nom']}"?>>Oui</a>
